...
module feature_buffer_sync #(
    ...
    wire [INDEX_WIDTH-1:0] mem_waddr;
    wire [INDEX_WIDTH-1:0] mem_raddr;

    assign mem_waddr = waddr[INDEX_WIDTH-1:0];
    assign mem_raddr = raddr[INDEX_WIDTH-1:0];

    generate
        if (ADDR_WIDTH > INDEX_WIDTH) begin : gen_unused_addr_bits
            /* verilator lint_off UNUSEDSIGNAL */
            wire unused_addr_bits = |waddr[ADDR_WIDTH-1:INDEX_WIDTH] | |raddr[ADDR_WIDTH-1:INDEX_WIDTH];

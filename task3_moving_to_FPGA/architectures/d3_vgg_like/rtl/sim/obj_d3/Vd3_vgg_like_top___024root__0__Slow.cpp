...
VL_ATTR_COLD void Vd3_vgg_like_top___024root___eval_initial(Vd3_vgg_like_top___024root* vlSelf) {
    ...
    // Body
    VL_READMEM_N(true, 8, 864, 0, "artifacts/int8_params/conv1_weight.mem"s
                 ,  &(vlSelfRef.d3_vgg_like_top__DOT__rw1__DOT__rom)
                 , 0, ~0ULL);
    VL_READMEM_N(true, 8, 9216, 0, "artifacts/int8_params/conv2_weight.mem"s
    ...
    while (VL_GTS_III(32, 0x00009000U, __Vinline__eval_initial__TOP_d3_vgg_like_top__DOT__rw4__DOT__index)) {
        vlSelfRef.d3_vgg_like_top__DOT__rw4__DOT____Vlvbound_h3992025e__0 = 0U;
        if (VL_LIKELY(((0x8fffU >= (0x0000ffffU & __Vinline__eval_initial__TOP_d3_vgg_like_top__DOT__rw4__DOT__index))))) {
            vlSelfRef.d3_vgg_like_top__DOT__rw4__DOT__rom[(0x0000ffffU 
                                                           & __Vinline__eval_initial__TOP_d3_vgg_like_top__DOT__rw4__DOT__index)] 
                = vlSelfRef.d3_vgg_like_top__DOT__rw4__DOT____Vlvbound_h3992025e__0;
        }
        __Vinline__eval_initial__TOP_d3_vgg_like_top__DOT__rw4__DOT__index 
            = ((IData)(1U) + __Vinline__eval_initial__TOP_d3_vgg_like_top__DOT__rw4__DOT__index);
    }
    VL_READMEM_N(true, 8, 36864, 0, "artifacts/int8_params/conv4_weight.mem"s
                 ,  &(vlSelfRef.d3_vgg_like_top__DOT__rw4__DOT__rom)
                 , 0, ~0ULL);
    VL_READMEM_N(true, 8, 73728, 0, "artifacts/int8_params/conv5_weight.mem"s
    ...
    VL_READMEM_N(true, 8, 1280, 0, "artifacts/int8_params/linear_weight.mem"s
                 ...
                 , 0, ~0ULL);
    VL_READMEM_N(true, 32, 32, 0, "artifacts/int8_params/conv1_bias.mem"s
    ...
    VL_READMEM_N(true, 32, 64, 0, "artifacts/int8_params/conv3_bias.mem"s
                 ...
                 , 0, ~0ULL);
    VL_READMEM_N(true, 32, 64, 0, "artifacts/int8_params/conv4_bias.mem"s
                 ,  &(vlSelfRef.d3_vgg_like_top__DOT__rb4__DOT__rom)
                 , 0, ~0ULL);
    VL_READMEM_N(true, 32, 128, 0, "artifacts/int8_params/conv5_bias.mem"s
...
VL_ATTR_COLD void Vd3_vgg_like_top___024root___eval_initial__TOP(Vd3_vgg_like_top___024root* vlSelf) {
    ...
    while (VL_GTS_III(32, 0x00009000U, d3_vgg_like_top__DOT__rw4__DOT__index)) {
        vlSelfRef.d3_vgg_like_top__DOT__rw4__DOT____Vlvbound_h3992025e__0 = 0U;
        if (VL_LIKELY(((0x8fffU >= (0x0000ffffU & d3_vgg_like_top__DOT__rw4__DOT__index))))) {
            vlSelfRef.d3_vgg_like_top__DOT__rw4__DOT__rom[(0x0000ffffU 
...
#endif
            VL_FATAL_MT("rtl/src/d3_vgg_like_top.v", 3, "", "DIDNOTCONVERGE: Settle region did not converge after '--converge-limit' of 10000 tries");
        }
...
VL_ATTR_COLD void Vd3_vgg_like_top___024root___ctor_var_reset(Vd3_vgg_like_top___024root* vlSelf) {
    ...
    vlSelf->d3_vgg_like_top__DOT__c5_start = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 3025849731957383130ull);
    ...
    vlSelf->d3_vgg_like_top__DOT__c5_wa = VL_SCOPED_RAND_RESET_I(17, __VscopeHash, 5581164519959254150ull);
    ...
    vlSelf->d3_vgg_like_top__DOT__c5_wd = VL_SCOPED_RAND_RESET_I(8, __VscopeHash, 10487298094375421099ull);
    ...
    vlSelf->d3_vgg_like_top__DOT__rw1__DOT__rom_addr = VL_SCOPED_RAND_RESET_I(10, __VscopeHash, 8179324819715535985ull);
    for (int __Vi0 = 0; __Vi0 < 9216; ++__Vi0) {
        vlSelf->d3_vgg_like_top__DOT__rw2__DOT__rom[__Vi0] = VL_SCOPED_RAND_RESET_I(8, __VscopeHash, 1991653480595812295ull);
    }
    vlSelf->d3_vgg_like_top__DOT__rw2__DOT__rom_addr = VL_SCOPED_RAND_RESET_I(14, __VscopeHash, 15228019249655110280ull);
    ...
    vlSelf->d3_vgg_like_top__DOT__rw4__DOT____Vlvbound_h3992025e__0 = 0;
    for (int __Vi0 = 0; __Vi0 < 36864; ++__Vi0) {
    ...
    for (int __Vi0 = 0; __Vi0 < 73728; ++__Vi0) {
        vlSelf->d3_vgg_like_top__DOT__rw5__DOT__rom[__Vi0] = VL_SCOPED_RAND_RESET_I(8, __VscopeHash, 12075919599770379863ull);
    }
    ...
    for (int __Vi0 = 0; __Vi0 < 128; ++__Vi0) {
        vlSelf->d3_vgg_like_top__DOT__rb5__DOT__rom[__Vi0] = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 3803416482193378369ull);
    }
    ...
    vlSelf->d3_vgg_like_top__DOT__conv5__DOT__engine_start = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 1519844768681363332ull);
    vlSelf->d3_vgg_like_top__DOT__conv5__DOT__engine_done = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 15085470210471267128ull);
    vlSelf->d3_vgg_like_top__DOT__conv5__DOT__controller_busy = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 3830148724952236289ull);
    vlSelf->d3_vgg_like_top__DOT__conv5__DOT__controller_done = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 17200017858225112223ull);
    vlSelf->d3_vgg_like_top__DOT__conv5__DOT__raw_sum = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 17629772114321866715ull);
    vlSelf->d3_vgg_like_top__DOT__conv5__DOT__biased_sum_reg = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 14560709605030437017ull);
    vlSelf->d3_vgg_like_top__DOT__conv5__DOT__product_reg = VL_SCOPED_RAND_RESET_Q(43, __VscopeHash, 2746361575488212026ull);
    vlSelf->d3_vgg_like_top__DOT__conv5__DOT__activated = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 18096007283072830880ull);
    vlSelf->d3_vgg_like_top__DOT__conv5__DOT__out_row = VL_SCOPED_RAND_RESET_I(16, __VscopeHash, 2339672737145103862ull);
    vlSelf->d3_vgg_like_top__DOT__conv5__DOT__out_col = VL_SCOPED_RAND_RESET_I(16, __VscopeHash, 5593070076711746583ull);
    vlSelf->d3_vgg_like_top__DOT__conv5__DOT__out_channel = VL_SCOPED_RAND_RESET_I(16, __VscopeHash, 18058223671184493702ull);
    vlSelf->d3_vgg_like_top__DOT__conv5__DOT__controller_out_addr = VL_SCOPED_RAND_RESET_I(17, __VscopeHash, 9351873234191346390ull);
    vlSelf->d3_vgg_like_top__DOT__conv5__DOT__postprocess_pending = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 2313321516826767836ull);
    vlSelf->d3_vgg_like_top__DOT__conv5__DOT__product_valid = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 1326146433729762460ull);
    vlSelf->d3_vgg_like_top__DOT__conv5__DOT__postprocess_valid = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 12719150738366186987ull);
    vlSelf->d3_vgg_like_top__DOT__conv5__DOT__product_addr_reg = VL_SCOPED_RAND_RESET_I(17, __VscopeHash, 6034195759971959507ull);
    vlSelf->d3_vgg_like_top__DOT__conv5__DOT__out_data_reg = VL_SCOPED_RAND_RESET_I(8, __VscopeHash, 854766133466424871ull);
    vlSelf->d3_vgg_like_top__DOT__conv5__DOT__out_addr_reg = VL_SCOPED_RAND_RESET_I(17, __VscopeHash, 14691860187217381485ull);
    vlSelf->d3_vgg_like_top__DOT__conv5__DOT__controller_done_d1 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 15068487166026245571ull);
    vlSelf->d3_vgg_like_top__DOT__conv5__DOT__controller_done_d2 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 18344868929655972593ull);
    vlSelf->d3_vgg_like_top__DOT__conv5__DOT__controller__DOT__state = VL_SCOPED_RAND_RESET_I(2, __VscopeHash, 11531713852535106566ull);
    vlSelf->d3_vgg_like_top__DOT__conv5__DOT__engine__DOT__state = VL_SCOPED_RAND_RESET_I(2, __VscopeHash, 14186703567122066924ull);
    vlSelf->d3_vgg_like_top__DOT__conv5__DOT__engine__DOT__ic = VL_SCOPED_RAND_RESET_I(16, __VscopeHash, 10694632385607866752ull);
    vlSelf->d3_vgg_like_top__DOT__conv5__DOT__engine__DOT__kr = VL_SCOPED_RAND_RESET_I(2, __VscopeHash, 8383368282837421546ull);
    vlSelf->d3_vgg_like_top__DOT__conv5__DOT__engine__DOT__kc = VL_SCOPED_RAND_RESET_I(2, __VscopeHash, 7664724612591900154ull);
    vlSelf->d3_vgg_like_top__DOT__conv5__DOT__engine__DOT__valid_pixel = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 4850258441769966327ull);
    vlSelf->d3_vgg_like_top__DOT__conv5__DOT__engine__DOT__product_reg = VL_SCOPED_RAND_RESET_I(16, __VscopeHash, 2699989186723279162ull);
    vlSelf->d3_vgg_like_top__DOT__conv5__DOT__engine__DOT__product_valid = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 2455011721207728369ull);
    vlSelf->d3_vgg_like_top__DOT__conv5__DOT__engine__DOT__product_last = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 6114931042037227576ull);
    vlSelf->d3_vgg_like_top__DOT__conv5__DOT__engine__DOT__last_item = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 11414894597066194415ull);
    ...
    vlSelf->__Vdly__d3_vgg_like_top__DOT__c5_start = 0;
    ...
    vlSelf->__Vdly__d3_vgg_like_top__DOT__conv5__DOT__engine_start = 0;
    vlSelf->__Vdly__d3_vgg_like_top__DOT__conv5__DOT__controller__DOT__state = 0;
    vlSelf->__Vdly__d3_vgg_like_top__DOT__conv5__DOT__engine__DOT__state = 0;
    vlSelf->__Vdly__d3_vgg_like_top__DOT__conv5__DOT__engine__DOT__ic = 0;
    vlSelf->__Vdly__d3_vgg_like_top__DOT__conv5__DOT__engine__DOT__product_reg = 0;
    vlSelf->__Vdly__d3_vgg_like_top__DOT__conv5__DOT__engine__DOT__product_valid = 0;
    vlSelf->__Vdly__d3_vgg_like_top__DOT__conv5__DOT__engine__DOT__product_last = 0;
